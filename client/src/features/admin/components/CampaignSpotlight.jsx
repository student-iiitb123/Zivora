function CampaignSpotlight() {
  return (
    <div className="bg-black relative group overflow-hidden shadow-[0_10px_40px_-15px_rgba(0,0,0,0.08)] min-h-[350px]">
      <img
        alt="Luxury Store"
      ...
      <div className="absolute inset-0 p-8 flex flex-col justify-end">
        <span className="text-white/60 text-[10px] font-bold uppercase tracking-[3px] mb-2">
          Campaign Spotlight
        </span>
        ...
        <button className="w-max bg-white text-black px-6 py-2 uppercase text-sm">
          View Details
        </button>
      </div>
    </div>
