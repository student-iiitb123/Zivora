      ...
      <div className="max-w-[1440px] mx-auto px-8 lg:px-12 py-4 flex justify-between items-center">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex gap-6">
            <Link className="font-label-md text-label-md text-primary border-b border-primary pb-1" to="/men">MEN</Link>
            <Link className="font-label-md text-label-md text-secondary hover:text-primary transition-colors" to="/women">WOMEN</Link>
            <Link className="font-label-md text-label-md text-secondary hover:text-primary transition-colors" to="/new-arrivals">NEW ARRIVALS</Link>
            <Link className="font-label-md text-label-md text-secondary hover:text-primary transition-colors" to="/collections">COLLECTIONS</Link>
            <Link className="font-label-md text-label-md text-secondary hover:text-primary transition-colors" to="/sale">SALE</Link>
          </nav>
        </div>
