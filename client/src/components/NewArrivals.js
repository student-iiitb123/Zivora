    ...
    <section className="py-24 lg:py-32 bg-white">
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-12">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-[40px] font-semibold tracking-tight text-black mb-8">
            NEW ARRIVALS
          </h2>

          <div className="flex justify-center gap-8 border-b border-black/10 pb-4 max-w-2xl mx-auto">
            <button className="text-sm font-medium text-black border-b-2 border-black -mb-[18px] pb-4">
              ALL
            </button>
            <button className="text-sm font-medium text-black/50 hover:text-black transition-colors pb-4">
              MEN
            </button>
            <button className="text-sm font-medium text-black/50 hover:text-black transition-colors pb-4">
              WOMEN
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
          <div className="group cursor-pointer">
            ...
            <h5 className="text-sm font-medium text-black uppercase">
              Cashmere Knitwear
            </h5>
            <p className="text-sm text-black/60">$340</p>
          </div>
          ...
          <div className="group cursor-pointer md:mt-12">
            ...
            <p className="text-sm text-black/60">$890</p>
          </div>
          ...
          <div className="group cursor-pointer">
            ...
            <p className="text-sm text-black/60">$520</p>
          </div>
          ...
          <div className="group cursor-pointer md:mt-12">
            ...
            <p className="text-sm text-black/60">$410</p>
          </div>
        </div>
      </div>
    </section>
